                ...
                <div className="form-container">
                    <form id="miformacion" onSubmit={handleSubmit} encType="multipart/form-data">
                        <div className="form-group">
                            <label className="label-trabaja" htmlFor="fecha-postulacion">Fecha de Postulación:</label>
                            <input type="date" id="fecha-postulacion" name="fecha-postulacion" required />
                        </div>

                        <div className="form-group">
                            <label className="label-trabaja" htmlFor="nombre-apellido">Nombre y Apellido:</label>
                            <input type="text" id="nombre-apellido" name="nombre-apellido" required />
                        </div>

                        <div className="form-group">
                            <label className="label-trabaja" htmlFor="nivel-educativo">Nivel Educativo:</label>
                        ...
                        <div className="form-group">
                            <label className="label-trabaja" htmlFor="pais-domicilio">Departamento:</label>
                        ...
                        <div className="form-group">
                            <label className="label-trabaja" htmlFor="Municipio-domicilio">Ciudad:</label>
