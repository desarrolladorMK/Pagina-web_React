...
const HistorialTransporte = () => {
  ...
  // Función que devuelve la clase CSS según el estado
  ...
  if (loading) return <div className="historialTableContainer"><p>Cargando historial...</p></div>;
  if (error) return <div className="historialTableContainer"><p>Error: {error}</p></div>;
            ...
            <tr key={index}>
              ...
              <td>
                {editingId === registro.id ? (
                  ...
                  <span className={getEstadoClass(registro.estado || 'Pendiente')}>
              ...
              <td>
                {editingId === registro.id ? (
                  <>
                    ...
                    {updateMessage && (
                      <p className={`transporte-message ${updateMessage.type}`}>
                        {updateMessage.text}
                      </p>
                    )}
                  </>
                ) : (
                  <button className="edit-button" onClick={() => handleEditClick(registro)}>
                    Editar
                  </button>
                )}
              </td>
