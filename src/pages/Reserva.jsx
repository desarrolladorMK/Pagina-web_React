  ...
  const handleSubmit = (event) => {
    ...
    Swal.fire({
      ...
      html: `
        ...
        <p><strong>Fecha:</strong> ${fecha ? fecha.toISOString().split("T")[0] : "No seleccionada"
        }</p> 
    ...
    <div>
      {!mostrarCancelar && (
        <div className="reserva-container">
          <h2 className="reserva-title">Reserva tu espacio</h2>
          <form className="reserva-form" onSubmit={handleSubmit}>
            ...
            <div className="reserva-form-group">
              ...
              />
              {errorNombre && (
                <p className="reserva-error-text">{errorNombre}</p>
              )}
            </div>
            <div className="reserva-form-group">
            ...
            <div className="reserva-form-group">
              ...
              ></textarea>
              {errorMotivo && (
                <p className="reserva-error-text">{errorMotivo}</p>
              )}
            </div>
            <div className="reserva-form-group">
              ...
              >
                ...
                {horariosDisponibles.map(({ hora, disponible, reservadoPor }) => (
                  <option key={hora} value={hora} disabled={!disponible}>
                    {hora} {disponible ? "" : `Reservado por: ${reservadoPor || "nul"}`}
                  </option>
                ))}
              </select>
            </div>
      ...
      {mostrarCancelar && (
        <div className="cancelar-container">
          <h2 className="cancelar-title">Cancelar Reserva</h2>
          <form className="cancelar-form" onSubmit={handleCancelarSubmit}>
            <div className="cancelar-form-group">
              <label htmlFor="nombre">Nombre y Apellido:</label>
              <input
                type="text"
                id="nombre"
